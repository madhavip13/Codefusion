...
//	         public  void   WriteData (String sheetname, int rownum, int column, String ID, String RecipeName, String RecipeCategory,
...
//			String NutriValue, String URL) throws IOException
	...
	public void WriteData(String sheetname, int rownum, int column, String ID, String RecipeName,
			String RecipeCategory,String foodCatogory,
			String IngreList, String PreTime, String cookingTime, String PrepMethod, String NutriValue,
			 String URL,String morbityDetails) throws IOException
		
	{
		
		String projectDir=System.getProperty("user.dir");
		String path=projectDir+"/src/test/java/Hypothyroidism_TestData/HypothyroidismRecipeList.xlsx";
